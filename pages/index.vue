          ...
          <v-row no-gutters>
            ...
            >
              <v-card tile py-2 class="ma-3" :elevation="5" align="center">
                ...
                <div align="right">
                  <nuxt-link
                    :to="'/earlyCourse/' + course._id"
                    style="text-decoration: none"
                  >
                    <v-btn
                      class="ma-1"
                      color="blue lighten-2 white--text font-weight-bold"
                      large
                      :elevation="5"
                      >詳細をみる</v-btn
                    >
...
export default {
  ...
  mounted() {
    axios
      .get("https://gifu-u-course-api.azurewebsites.net/api/v1/early")
      .then((response) => {
      ...
      axios
        .get(
          "https://gifu-u-zenkyo-api.netlify.app/.netlify/functions/api/v1/latter"
        )
        .then((response) => {
          console.log("Success to Fetch API");
